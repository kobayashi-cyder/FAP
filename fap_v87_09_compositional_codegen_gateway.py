...
VERSION = "87.09-compositional-codegen"
...
def http_json(url: str, method: str = "GET", data: dict | None = None, timeout: float = 12.0) -> Any:
    ...
    req.add_header("User-Agent", "FAP-V87.09/1.0")
...
class FAPV8709:
    def __init__(self):
        ...
        self.codegen = CompositionalCodeGenerator(ARTIFACTS, RUNTIME / "code_workspace")
        self.e2b = E2BOrgan()
    ...
    def capabilities(self) -> list[str]:
        caps = [
            ...
            "builder-stage4", "builder:spec-compiler", "code-generator-stage2", "codegen:primitive-composition", "codegen:python", "codegen:html", "codegen:json", "codegen:markdown", "codegen:self-test", "codegen:repair-loop", "builder:constraint-extractor", "builder:generic-grid-composer", "builder:concept-resolver", "builder:mechanism-decomposition", "builder:generic-intent", "builder:composition", "builder:single-html", "builder:tetris", "builder:breakout", "builder:pong", "builder:snake", "builder:minesweeper", "builder:2048", "builder:memory-match", "builder:json",
    ...
    def status(self) -> dict:
        ...
        return {
            ...
            "code_generator": {"stage": 2, "local": True, "mode": "codespec-primitive-compose-verify-selftest-repair", "targets": ["python_calculator", "python_csv_stats", "python_composed", "html_notepad", "html_counter", "html_composed", "json_config", "markdown_document"]},
            "e2b": teacher,
        ...
        if intent.name == "builder":
            if self.codegen.claims(text):
                try:
                    ...
                    return {"ok": False, "reply": f"Code Generator Stage 2では完了できませんでした: {e}", "confidence": 0.86}
            try:
...
def main() -> None:
    ...
    print(f"FAP V{VERSION} Distilled + Specification Compiler + Compositional Code Generator Gateway")
    ...
    print("Code Generator: V87.09 CodeSpec + primitive composition + self-test + repair loop (Stage 2)")
