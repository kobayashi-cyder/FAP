...
def http_json(url: str, method: str = "GET", data: dict | None = None, timeout: float = 12.0) -> Any:
    ...
    req.add_header("User-Agent", "FAP-V87.07/1.0")
...
class FAPV8707:
    ...
    def capabilities(self) -> list[str]:
        caps = [
            ...
            "builder-stage4", "builder:spec-compiler", "builder:constraint-extractor", "builder:generic-grid-composer", "builder:concept-resolver", "builder:mechanism-decomposition", "builder:generic-intent", "builder:composition", "builder:single-html", "builder:tetris", "builder:breakout", "builder:pong", "builder:snake", "builder:minesweeper", "builder:2048", "builder:memory-match", "builder:json",
...
def main() -> None:
    ...
    print(f"FAP V{VERSION} Distilled + Specification Compiler Capability Gateway")
