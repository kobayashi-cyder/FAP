# Horizontal workstream: benchmark

Branch: `horiz/coding-benchmark`
Integration target: `integration/coding-horizontal-v8781`
Release line: V87.81 (no version bump on this branch)

## Scope

Reproducible coding capability benchmarks and measurements.

## First deliverables

Add fixtures, success/failure metrics, latency/repair counters and machine-readable reports.
