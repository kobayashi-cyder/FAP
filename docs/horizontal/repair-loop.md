# Horizontal workstream: repair-loop

Branch: `horiz/coding-repair-loop`
Integration target: `integration/coding-horizontal-v8781`
Release line: V87.81 (no version bump on this branch)

## Scope

Bounded repair quality and evidence-driven failure correction.

## First deliverables

Use verifier evidence to target repairs, prevent oscillation, cap attempts and retain deterministic audit data.
