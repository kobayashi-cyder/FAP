# Horizontal workstream: dependency-impact

Branch: `horiz/coding-dependency-impact`
Integration target: `integration/coding-horizontal-v8781`
Release line: V87.81 (no version bump on this branch)

## Scope

Reverse dependency and affected-test analysis.

## First deliverables

Identify downstream modules/tests with bounded graph walks and deterministic evidence.
