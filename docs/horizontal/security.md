# Horizontal workstream: security

Branch: `horiz/coding-security`
Integration target: `integration/coding-horizontal-v8781`
Release line: V87.81 (no version bump on this branch)

## Scope

Security boundaries for repository coding.

## First deliverables

Harden path policy, executable/command policy, secret-safe error reporting and fail-closed mutation gates.
