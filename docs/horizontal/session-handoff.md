# Horizontal workstream: session-handoff
...
Cross-chat and cross-agent repository coding continuity.

## First deliverables

Persist content-free plans, digests, branch/base identity and resumable workstream state without leaking source.
