# Horizontal workstream: context-retrieval

Branch: `horiz/coding-context-retrieval`
Integration target: `integration/coding-horizontal-v8781`
Release line: V87.81 (no version bump on this branch)

## Scope

Higher-quality repository context, symbol and dependency retrieval.

## First deliverables

Improve relevance ranking, bounded dependency expansion and stale-context detection.
