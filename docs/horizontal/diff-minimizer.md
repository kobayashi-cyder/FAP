# Horizontal workstream: diff-minimizer

Branch: `horiz/coding-diff-minimizer`
Integration target: `integration/coding-horizontal-v8781`
Release line: V87.81 (no version bump on this branch)

## Scope

Minimize safe code diffs while preserving requested behavior.

## First deliverables

Score candidate patches by changed surface; reject needless churn; retain semantic verification.
