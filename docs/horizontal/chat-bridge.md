# Horizontal workstream: chat-bridge
...
Conversation-to-coding routing, task extraction and result handoff.

## First deliverables

Preserve conversational context without leaking raw source; route coding intent into structured repository work.
