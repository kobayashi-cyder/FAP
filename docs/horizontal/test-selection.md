# Horizontal workstream: test-selection

Branch: `horiz/coding-test-selection`
Integration target: `integration/coding-horizontal-v8781`
Release line: V87.81 (no version bump on this branch)

## Scope

Higher-precision automatic focused/regression test selection.

## First deliverables

Combine filename, symbol and dependency evidence; bound selected tests; fail closed when required coverage is unavailable.
