# Imported from kobayashi-cyder/FMG main (FMG Fly Connectome V2.x).
# FAP integration keeps the controller logic intact while namespacing the module.
# Source commit at import time: dd57b636f67a1279403048bcb75b66c0cbb50b04
