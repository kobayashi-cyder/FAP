# FAP V87.28 — Native Image Engine

V87.28 introduces a FAP-owned image generator that can produce real PNG files
...
This distinction is intentional: V87.28 establishes a generator FAP owns from
...
```text
RUN_FAP_V87_28_NATIVE_IMAGE_LAB.cmd
```
...
V87.28 reuses the verified V87.13-V87.20 media contracts, observer, critic,
