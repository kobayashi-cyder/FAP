...
class PersistenceIdentityTests(unittest.TestCase):
    ...
    def test_cross_capability_ids_do_not_collide(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertTrue(ledger.insert(capability_id="cap-b", event_id="event-1", candidate_digest="d2", attestation_id="att-1", payload={"ok": True}))
            self.assertFalse(ledger.insert(capability_id="cap-a", event_id="event-1", candidate_digest="d3", attestation_id="att-2", payload={"ok": False}))
