...
def build_v80_responder(
    ...
    *,
    ...
    """Compose V80 sparse adaptive circuits in front of V78 learned guidance.

    Call order:
        user -> V80 sparse/verified creativity -> V78 learned guidance -> base responder
    """
