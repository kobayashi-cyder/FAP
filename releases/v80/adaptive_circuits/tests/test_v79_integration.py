...
from fap_adaptive_circuits import SparseCreativityAdapter, build_v80_responder
...
class V79IntegrationTests(unittest.TestCase):
    ...
    def test_v80_composes_with_v78_teacher_learning(self):
        seen = {}
        ...
        responder = build_v80_responder(base, top_k=2)
        result = responder("エラーを省メモリで直して", "prior", "rich")
        self.assertEqual(result, "V80-COMPOSED")
        self.assertIn("[FAP V80 sparse creativity guidance]", seen["context"])
