...
class SmallRasterRenderer:
    """Dependency-free renderer for Visual Primitives."""
...
class CallableRendererAdapter:
    """Optional replacement point for diffusion or another renderer."""

    def __init__(self, fn: Callable[[VisualIR], RasterFrame]):
        if not callable(fn):
