...
from .engine import HumanLBSEngine


class HumanLBSManager:
    def __init__(
        self,
        *,
        ...
        self.engine = HumanLBSEngine(artifact_dir=self.artifact_dir)
    ...
    def generate(self, request: GenerationRequest) -> MediaSkillRun:
        ...
        if request.media_type != "image":
            raise RuntimeError("human LBS manager supports image generation only")
