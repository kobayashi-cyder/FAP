...
where py >nul 2>&1
if not errorlevel 1 (
  start "FAP V87.28 Native Image Lab" /min py -3 "%~dp0fap_v87_28_native_image_lab.py"
  goto :open
)

where python >nul 2>&1
if not errorlevel 1 (
  start "FAP V87.28 Native Image Lab" /min python "%~dp0fap_v87_28_native_image_lab.py"
  goto :open
)
