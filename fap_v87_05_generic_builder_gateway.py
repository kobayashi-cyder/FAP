...
from fap_generic_builder import GenericCompositionBuilder, BuilderError

ROOT = Path(__file__).resolve().parent
WEB_FILE = ROOT / "web" / "FAP_Chat.html"
RUNTIME = ROOT / "runtime" / "v87_05"
...
class FAPV8705:
    def __init__(self):
        ...
        self.builder = GenericCompositionBuilder(ARTIFACTS, RUNTIME / "workspace")
        self.e2b = E2BOrgan()
    ...
    def capabilities(self) -> list[str]:
        caps = [
            ...
            "builder-stage2", "builder:generic-intent", "builder:composition", "builder:single-html", "builder:tetris", "builder:breakout", "builder:pong", "builder:snake", "builder:json",
    ...
    def status(self) -> dict:
        ...
        return {
            ...
            "builder": {"stage": 2, "local": True, "mode": "feature-to-primitive-composition", "targets": ["tetris", "breakout", "pong", "snake", "generic_page", "generic_config"]},
            "e2b": teacher,
    ...
    def route(self, intent: Intent, text: str, history: list[dict]) -> dict:
        ...
        if intent.name == "builder":
            try:
                ...
                return {"ok": False, "reply": f"Builder Stage 2では完了できませんでした: {e}", "confidence": 0.86}
...
def main() -> None:
    ...
    print("Builder: V87.05 generic composition builder (Stage 2)")
