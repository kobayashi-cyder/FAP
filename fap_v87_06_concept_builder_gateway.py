...
from fap_concept_builder import ConceptMechanismBuilder, BuilderError

ROOT = Path(__file__).resolve().parent
WEB_FILE = ROOT / "web" / "FAP_Chat.html"
RUNTIME = ROOT / "runtime" / "v87_06"
...
def http_json(url: str, method: str = "GET", data: dict | None = None, timeout: float = 12.0) -> Any:
    ...
    req.add_header("User-Agent", "FAP-V87.02/1.0")
...
class FAPV8706:
    def __init__(self):
        ...
        self.builder = ConceptMechanismBuilder(ARTIFACTS, RUNTIME / "workspace")
        self.e2b = E2BOrgan()
    ...
    def capabilities(self) -> list[str]:
        caps = [
            ...
            "builder-stage3", "builder:concept-resolver", "builder:mechanism-decomposition", "builder:generic-intent", "builder:composition", "builder:single-html", "builder:tetris", "builder:breakout", "builder:pong", "builder:snake", "builder:minesweeper", "builder:2048", "builder:memory-match", "builder:json",
    ...
    def status(self) -> dict:
        ...
        return {
            ...
            "builder": {"stage": 3, "local": True, "mode": "concept-to-mechanism-composition", "targets": ["tetris", "breakout", "pong", "snake", "minesweeper", "2048", "memory_match", "generic_page", "generic_config"]},
            "e2b": teacher,
    ...
    def route(self, intent: Intent, text: str, history: list[dict]) -> dict:
        ...
        if intent.name == "builder":
            try:
                ...
                return {"ok": False, "reply": f"Builder Stage 3では完了できませんでした: {e}", "confidence": 0.86}
...
def main() -> None:
    ...
    print(f"FAP V{VERSION} Distilled + Concept Builder Capability Gateway")
    print(f"UI: http://{HOST}:{PORT}/")
    print("Local brain: V78 distilled circuits + teacher-shadow")
    print("Builder: V87.06 concept-to-mechanism builder (Stage 3)")
