...
class FAPV1001Unified(v81.FAPV8781Unified):
    ...
    @staticmethod
    def _intelligence_target_status():
        return {
        ...
        out.update(
            {
                ...
                "dynamic_sparse_routing": self._dynamic_sparse_status(),
                "intelligence_target": self._intelligence_target_status(),
            }
        )
